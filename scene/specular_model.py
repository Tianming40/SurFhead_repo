...
class SpecularModel:
    def __init__(self, sg_type='asg'):
        self.sg_type = sg_type
        self.specular = SpecularNetwork(sg_type = sg_type).cuda()
        self.optimizer = None
        self.spatial_lr_scale = 5

    def step(self, asg_feature, viewdir, normal, sg_type = 'asg'):
        return self.specular(asg_feature, viewdir, normal, sg_type)
