...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    if dataset.bind_to_mesh:
        ...
        gaussians = FlameGaussianModel(sh_degree=3, sg_degree=dataset.sg_degree, brdf_dim=-1,
    ...
    for iteration in range(first_iter, opt.iterations + 1):
        ...
        with torch.no_grad():
            ...
            training_report(tb_writer, iteration, losses, iter_start.elapsed_time(iter_end), testing_iterations, scene, render, render_args, specular_mlp)
